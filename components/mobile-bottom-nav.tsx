...
import { Home, Briefcase, Activity, FlaskConical, Menu } from "lucide-react";
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center w-full h-full gap-1 active:scale-95 transition-transform duration-150",
