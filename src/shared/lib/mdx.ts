...
import { CaseModePanel } from "@/widgets/case-mode-panel";
import { ShopifySyncDiagram } from "@/widgets/mdx/ShopifySyncDiagram";
import { RedactionNote } from "@/widgets/mdx/RedactionNote";
import { SystemSpec } from "@/widgets/mdx/SystemSpec";

// Infrastructure Academy Widgets
import { CloudTaxCalculator } from "@/widgets/infrastructure/academy/cloud-tax-calculator";
import { VcpuCoreExplainer } from "@/widgets/infrastructure/academy/vcpu-core-explainer";
import { EvidencePanel } from "@/widgets/infrastructure/academy/evidence-panel";
