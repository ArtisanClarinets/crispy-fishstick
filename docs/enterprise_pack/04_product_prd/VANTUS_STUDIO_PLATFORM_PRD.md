...
> **Strategy Note:** VSP is an internal delivery tool, NOT a SaaS product for sale.
> Option A — Gulf Coast Leader: We build websites, not platforms.

**Version:** 1.2
**Date:** 2026-03-15
**Owner:** Dylan Thompson
**Status:** Internal tool, not for external sale
